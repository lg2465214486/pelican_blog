...
文件夹内有一个音频`.mp3`文件、一个不带音频的`.mp4`文件、以及一个合成后的`.mp4`文件

执行结果如下图：

[![图1]({static}/images/bilibili_video_crawler/1.png){: width="50%"}]({static}/images/bilibili_video_crawler/1.png){: data-lightbox="gallery" .lightbox-image }
...
[github源码地址](https://github.com/lg2465214486/tools/blob/main/python/crawler/bilibili_video_crawler.py)
